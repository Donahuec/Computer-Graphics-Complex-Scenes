...
Demonstrates Level Of Detail nodes.
*/
...
int initializeScene(void) {
	...
	if (sceneInitializeLOD(&lodNodeL, 3, 3, NULL, NULL, NULL) != 0)
		return 26;
	if (sceneInitializeTransformation(&transformationNodeL10, 3, NULL, NULL, &lodNodeL, NULL) != 0)
		return 27;
	if (sceneInitializeTransformation(&transformationNodeL9, 3, NULL, NULL, &lodNodeL, &transformationNodeL10) != 0)
		return 28;
	if (sceneInitializeTransformation(&transformationNodeL8, 3, NULL, NULL, &lodNodeL, &transformationNodeL9) != 0)
		return 29;
	if (sceneInitializeTransformation(&transformationNodeL7, 3, NULL, NULL, &lodNodeL, &transformationNodeL8) != 0)
		return 30;
	if (sceneInitializeTransformation(&transformationNodeL6, 3, NULL, NULL, &lodNodeL, &transformationNodeL7) != 0)
		return 31;
	if (sceneInitializeTransformation(&transformationNodeL5, 3, NULL, NULL, &lodNodeL, &transformationNodeL6) != 0)
		return 32;
	if (sceneInitializeTransformation(&transformationNodeL4, 3, NULL, NULL, &lodNodeL, &transformationNodeL5) != 0)
		return 33;
	if (sceneInitializeTransformation(&transformationNodeL3, 3, NULL, NULL, &lodNodeL, &transformationNodeL4) != 0)
		return 34;
	...
	if (sceneInitializeLOD(&lodNodeT, 3, 3, NULL, NULL, NULL) != 0)
		return 40;
	if (sceneInitializeTransformation(&transformationNodeT10, 3, NULL, NULL, &lodNodeT, &nodeW) != 0)
		return 41; 
	if (sceneInitializeTransformation(&transformationNodeT9, 3, NULL, NULL, &lodNodeT, &transformationNodeT10) != 0)
		return 42; 
	if (sceneInitializeTransformation(&transformationNodeT8, 3, NULL, NULL, &lodNodeT, &transformationNodeT9) != 0)
		return 43; 
	if (sceneInitializeTransformation(&transformationNodeT7, 3, NULL, NULL, &lodNodeT, &transformationNodeT8) != 0)
		return 44; 
	if (sceneInitializeTransformation(&transformationNodeT6, 3, NULL, NULL, &lodNodeT, &transformationNodeT7) != 0)
		return 45; 
	if (sceneInitializeTransformation(&transformationNodeT5, 3, NULL, NULL, &lodNodeT, &transformationNodeT6) != 0)
		return 46; 
	if (sceneInitializeTransformation(&transformationNodeT4, 3, NULL, NULL, &lodNodeT, &transformationNodeT5) != 0)
		return 47; 
	if (sceneInitializeTransformation(&transformationNodeT3, 3, NULL, NULL, &lodNodeT, &transformationNodeT4) != 0)
		return 48; 
...
int main(void) {
    ...
    while (glfwWindowShouldClose(window) == 0) {
    	oldTime = newTime;
    	newTime = getTime();
    	if(check == 0 && cam.translation[2]<125.0){
    		camAddDistance(&cam, 0.5);
    	} else if (cam.translation[2]>=125.0){
    		check = 1;
    	}
